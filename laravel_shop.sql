...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=3748115705ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=laravel_shop&table=migrations">`laravel_shop`.`migrations`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=laravel_shop&table=failed_jobs">`laravel_shop`.`failed_jobs`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=laravel_shop&table=carts">`laravel_shop`.`carts`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=laravel_shop&table=products">`laravel_shop`.`products`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=laravel_shop&table=production_detailsails">`laravel_shop`.`production_detailsails`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=laravel_shop&table=users">`laravel_shop`.`users`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="4d236d5b717057744c4b63592b766168">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="laravel_shop" targettable="products">
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO products VALUES (10,&#039;Şeker Portakalı&#039;,&#039;roman&#039;,&#039; Can Çocuk Yayınları - Çağdaş Dünya Edebiyatı Dizisi&#039;,&#039;Şeker Portakalı Kitap Açıklaması&#039;,&#039;https://i.dr.com.tr/cache/500x400-0/originals/0000000064031-1.jpg&#039;,27,20,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="laravel_shop" targettable="production_detailsails">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `production_detailsails`</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="laravel_shop" targettable="production_detailsails">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO production_detailsails (product_id,Yazar,Çevirmen,Sayfa_Sayisi,Dil) VALUES (10,&#039;Yazar: Jose Mauro De Vasconcelos&#039;,&#039;Çevirmen: Emrah İmre&#039;,&#039;Sayfa Sayısı: 200&#039;,&#039;Dil: Türkçe&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="laravel_shop" targettable="products">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO products VALUES (11,&#039;Türlerin Kökeni&#039;,&#039;bilim&#039;,&#039;Alfa Yayıncılık&#039;,&#039;Türlerin Kökeni Kitap Açıklaması&#039;,&#039;https://i.dr.com.tr/cache/500x400-0/originals/0001719848001-1.jpg&#039;,39,20,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="laravel_shop" targettable="production_detailsails">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO production_detailsails (product_id,Yazar,Çevirmen,Baski_Sayisi,İlk_Baski_Yili) VALUES (11,&#039;Yazar: Charles Darwin&#039;,&#039;Çevirmen: Bahar Kılıç&#039;,&#039;Baskı Sayısı: 1. Basım&#039;,&#039;İlk Baskı Yılı: 2017&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="laravel_shop" targettable="products">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO products VALUES (12,&#039;İFA:İnsanın Fabrika Ayarları 1.Kitap-Beden&#039;,&#039;bilim&#039;,&#039;Tuti Kitap&#039;,&#039;İFA:İnsanın Fabrika Ayarları 1.Kitap-Beden Kitap Açıklaması&#039;,&#039;https://i.dr.com.tr/cache/500x400-0/originals/0001843838001-1.jpg&#039;,36,20,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="laravel_shop" targettable="production_detailsails">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO production_detailsails (product_id,Yazar,Baski_Sayisi,Dil,İlk_Baski_Yili) VALUES (12,&#039;Yazar: Sinan Canan&#039;,&#039;Baskı Sayısı: 1. Basım&#039;,&#039;Dil: Türkçe&#039;,&#039;İlk Baskı Yılı: 2019&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="laravel_shop" targettable="products">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `products`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="laravel_shop" targettable="carts">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `carts`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="laravel_shop" targettable="failed_jobs">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `failed_jobs`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="laravel_shop" targettable="migrations">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
